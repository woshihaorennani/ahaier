...
const regionData = {
    ...
    "重庆市": {
        "重庆市": ["五指山市*", "琼海市*", "文昌市*", "万宁市*", "东方市*", "定安县*", "屯昌县*", "澄迈县*", "临高县*", "白沙黎族自治县*", "昌江黎族自治县*", "乐东黎族自治县*", "陵水黎族自治县*", "保亭黎族苗族自治县*", "琼中黎族苗族自治县*", "万州区", "涪陵区", "渝中区", "大渡口区", "江北区", "沙坪坝区", "九龙坡区", "南岸区", "北碚区", "綦江区", "大足区", "渝北区", "巴南区", "黔江区", "长寿区", "江津区", "合川区", "永川区", "南川区", "璧山区", "铜梁区", "潼南区", "荣昌区", "开州区", "梁平区", "武隆区", "城口县", "丰都县", "垫江县", "忠县", "云阳县", "奉节县", "巫山县", "巫溪县", "石柱土家族自治县", "秀山土家族苗族自治县", "酉阳土家族苗族自治县", "彭水苗族土家族自治县"]
    },
    "四川省": {
    ...
    "新疆维吾尔自治区": {
        ...
        "和田地区": ["和田市", "和田县", "墨玉县", "皮山县", "洛浦县", "策勒县", "于田县", "民丰县", "和康县", "和安县"],
